    ...
    <xsl:template match="/">
        <html>
            <body>
                ...
                <xsl:apply-templates
                        select="wsdl:definitions/wsdl:types/xs:schema[starts-with(@targetNamespace, 'http://fmk-teknik.dk/')]/xs:complexType"
                        mode="all" />
                <xsl:apply-templates
                        select="wsdl:definitions/wsdl:types/xs:schema[starts-with(@targetNamespace, 'http://fmk-teknik.dk/')]/xs:simpleType" />
            </body>
        </html>
    </xsl:template>
</xsl:stylesheet>